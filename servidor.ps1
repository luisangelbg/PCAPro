# Servidor web local minimo para PCAPro.
# Uso:  clic derecho > "Ejecutar con PowerShell"
#       (o:  powershell -ExecutionPolicy Bypass -File servidor.ps1)
# Luego abre  http://localhost:8790  en Chrome o Edge.
#
# PCAPro calcula todo en JavaScript, asi que el doble clic en index.html tambien
# funciona. Se recomienda igual usar este servidor: solo asi cargan los archivos
# de ejemplo de la carpeta datos/ (el navegador bloquea leerlos desde file://).
#
...
# direccion (algo como http://192.168.1.23:8790) para escribirla en el
...
Write-Host ""
Write-Host "  PCAPro en marcha:  $prefix" -ForegroundColor Green
if ($lan) {
